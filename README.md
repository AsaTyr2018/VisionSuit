...
- **NSFW metadata screening** – LoRA uploads now normalize safetensor frequency tables into a reusable payload, score adult/minor/bestiality tags against configurable thresholds, persist the results in metadata, and automatically mark or queue models that cross review limits.
