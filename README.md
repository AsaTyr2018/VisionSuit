...
- **Adult content governance** – Administration → Safety lets admins mark tags as adult-only, automatically reclassifying linked models and renders while the API filters guests and members who disable the NSFW toggle in account settings.
