...
- **Live NSFW tagging** – Preview renders and gallery uploads now run through the OpenCV heuristics engine during ingestion, persist the resulting scores in asset metadata, and mark LoRAs or images as adult even when creators avoid explicit keywords.
