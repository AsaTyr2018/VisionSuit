...
- **Adult prompt governance** – Administration → Safety now manages configurable prompt keywords that automatically mark renders as adult when detected in metadata, keeping NSFW content hidden from guests and members who browse with the safe-mode toggle disabled.
