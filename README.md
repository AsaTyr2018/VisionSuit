...
- **NSFW rescan automation** – Administration → Safety now includes a one-click NSFW rescan that replays metadata heuristics and OpenCV analysis across existing models and gallery images, refreshing adult tags and queueing potentially illegal content for review.
