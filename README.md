...
- **NSFW metadata foundation** – JSON-backed keyword packs and backend normalization helpers now prepare LoRA metadata for the upcoming composite moderation engine so frequency tables can be scored consistently across ingestion workers.
