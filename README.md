...
- **Layered moderation workflow** – Members can flag problematic models or renders, flagged assets blur for everyone except administrators, and admins triage them in the new Moderation tab with approve/remove decisions that write audit notes for future notifications.
...
- Flagged models and renders blur automatically for members and curators; administrators always see clear previews and can approve or remove them while leaving the required audit note that will power the upcoming notification center.
