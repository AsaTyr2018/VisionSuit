...
- **On-Site Generator hub** – Role-aware wizard that lets curators compose prompts, mix LoRAs, pick dimensions, and enqueue generation jobs directly from VisionSuit while preserving per-user job history.
